...
try {
		Debug.PushSubsStack("on_ad_available (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,153);
...
Debug.locals.put("AdUnitId", _adunitid);
 BA.debugLineNum = 153;BA.debugLine="Sub on_ad_available(AdUnitId As String)";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 154;BA.debugLine="Log(\"AdAvailable\")";
Debug.ShouldStop(33554432);
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("AdAvailable")));
 BA.debugLineNum = 155;BA.debugLine="If AdUnitId == \"YourInterstitialAdUnitId\" Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",_adunitid,BA.ObjectToString("YourInterstitialAdUnitId"))) { 
 BA.debugLineNum = 156;BA.debugLine="Magnet.ShowInterstitial()";
Debug.ShouldStop(134217728);
main.mostCurrent._magnet.runVoidMethod ("ShowInterstitial",main.mostCurrent.activityBA);
 }else 
{ BA.debugLineNum = 157;BA.debugLine="Else If AdUnitId == \"YourRewardedAdUnitId\" Then";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("=",_adunitid,BA.ObjectToString("YourRewardedAdUnitId"))) { 
 BA.debugLineNum = 158;BA.debugLine="Magnet.ShowRewardAd()";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("on_ad_receive_fail (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,163);
if (RapidSub.canDelegate("on_ad_receive_fail")) return main.remoteMe.runUserSub(false, "main","on_ad_receive_fail", _adunitid);
Debug.locals.put("AdUnitId", _adunitid);
 BA.debugLineNum = 163;BA.debugLine="Sub on_ad_receive_fail(AdUnitId As String)";
Debug.ShouldStop(4);
 BA.debugLineNum = 164;BA.debugLine="Log(\"AdReceiveFail\")";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("on_reward_failed (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,171);
if (RapidSub.canDelegate("on_reward_failed")) return main.remoteMe.runUserSub(false, "main","on_reward_failed");
 BA.debugLineNum = 171;BA.debugLine="Sub on_reward_failed";
Debug.ShouldStop(1024);
 BA.debugLineNum = 172;BA.debugLine="Log(\"RewardFailed\")";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("on_reward_successful (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,167);
if (RapidSub.canDelegate("on_reward_successful")) return main.remoteMe.runUserSub(false, "main","on_reward_successful");
 BA.debugLineNum = 167;BA.debugLine="Sub on_reward_successful";
Debug.ShouldStop(64);
 BA.debugLineNum = 168;BA.debugLine="Log(\"You can give reward to your user here\")";
Debug.ShouldStop(128);
...
try {
		Debug.PushSubsStack("TabHost1_TabChanged (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,175);
if (RapidSub.canDelegate("tabhost1_tabchanged")) return main.remoteMe.runUserSub(false, "main","tabhost1_tabchanged");
 BA.debugLineNum = 175;BA.debugLine="Sub TabHost1_TabChanged";
Debug.ShouldStop(16384);
 BA.debugLineNum = 176;BA.debugLine="If TabHost1.CurrentTab = 3 Then";
Debug.ShouldStop(32768);
if (RemoteObject.solveBoolean("=",main.mostCurrent._tabhost1.runMethod(true,"getCurrentTab"),BA.numberCast(double.class, 3))) { 
 BA.debugLineNum = 177;BA.debugLine="FillScrollView";
Debug.ShouldStop(65536);
_fillscrollview();
 };
